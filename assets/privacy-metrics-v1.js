(function () {
  ...
  var allowedContents = allowlist([
    ...
    "encounter", "encounter_threats", "encounter_threats_compare",
    ...
    "generated_one_shot", "gullwatch_download", "gullwatch_harbor_featured_campaign",
    "gullwatch_harbor_preview", "gullwatch_release", "hero",
    "hero_full_campaign", "hero_generate_one_shot", "hero_prep_guide",
    "hero_shop_modules", "hero_start_free_from_direct", "hub_connected_trace",
    ...
    "idea_wrong_harbor", "item_catalog", "item_catalog_compare",
    "item_catalog_demo", "loot", "loot_calculator", "loot_odds",
    ...
    "open_browser_demo", "paid_encounter", "paid_loot", "paid_quest",
    ...
    "utility_index", "w1_free_rpg_tools", "w1_guides", "w1_gullwatch_kit",
