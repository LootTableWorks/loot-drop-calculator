...
- one first-viewport index to the five public free utilities;
...
The build writes only to `dist/` inside this project and creates `world-foundry-hub-static-site-v1-2.zip`. It does not deploy or publish.
